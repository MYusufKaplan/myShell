...
set pumheight=15
set ruler
set runtimepath=~/.SpaceVim.d/,~/.SpaceVim/,~/.SpaceVim/bundle/indentLine,~/.cache/vimfiles/repos/github.com/prabirshrestha/asyncomplete-buffer.vim,~/.SpaceVim/bundle/vim-textobj-line,~/.cache/vimfiles/repos/github.com/prabirshrestha/asyncomplete.vim,~/.SpaceVim/bundle/vim-emoji,~/.cache/vimfiles/repos/github.com/yami-beta/asyncomplete-omni.vim,~/.SpaceVim/bundle/vim-easyoperator-line,~/.SpaceVim/bundle/neomake,~/.SpaceVim/bundle/neosnippet-snippets,~/.SpaceVim/bundle/tagbar,~/.SpaceVim/bundle/open-browser.vim,~/.SpaceVim/bundle/vim-textobj-indent,~/.SpaceVim/bundle/vim-repeat,~/.SpaceVim/bundle/vim-matchup,~/.SpaceVim/bundle/gruvbox,~/.SpaceVim/bundle/CompleteParameter.vim,~/.SpaceVim/bundle/unite.vim,~/.SpaceVim/bundle/clever-f.vim,~/.SpaceVim/bundle/delimitMate,~/.SpaceVim/bundle/vim-expand-region,~/.SpaceVim/bundle/vim-choosewin,~/.SpaceVim/bundle/vimproc.vim,~/.SpaceVim/bundle/vim-textobj-user,~/.SpaceVim/bundle/tagbar-proto.vim,~/.SpaceVim/bundle/tabular,~/.SpaceVim/bundle/vim-easymotion,~/.SpaceVim/bundle/vim-startify,~/.SpaceVim/bundle/tagbar-makefile.vim,~/.SpaceVim/bundle/dein.vim,~/.SpaceVim/bundle/vim-table-mode,~/.SpaceVim/bundle/neoformat,~/.SpaceVim/bundle/vim-textobj-entire,~/.SpaceVim/bundle/vim-surround,~/.SpaceVim/bundle/deoplete-dictionary,~/.SpaceVim/bundle/editorconfig-vim,~/.SpaceVim/bundle/nerdcommenter,~/.SpaceVim/bundle/vimfiler.vim,~/.cache/vimfiles/.cache/vimrc/.dein,/usr/share/vim/vim81,~/.SpaceVim/bundle/indentLine/after,~/.SpaceVim/bundle/vim-matchup/after,~/.SpaceVim/bundle/CompleteParameter.vim/after,~/.SpaceVim/bundle/tabular/after,~/.cache/vimfiles/.cache/vimrc/.dein/after,~/.SpaceVim/bundle/dein.vim/,~/.SpaceVim/after
set scrolloff=1
set noshelltemp
set shiftwidth=2
